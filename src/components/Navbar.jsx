...
const Navbar = ({darkMode, toggleDarkMode}) => {
    ...
    const lightColor = {
        navBg: "bg-linear-to-br from-orrange-200 to-white",
                ...
                <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <motion.button
                            ...
                            {darkMode ? (
                                ...
                                ( <Moon className="w5 h-5 text-gray-700"/>
                            )}
                        ...
                        <motion.a
                            ...
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className={`hiddden lg:block px-6 py-2 font-semibold
                            rounded-full bg-linear-to-r ${colors.button} text-white shadow-md hover:shadow-lg transition-shadow`}>
                            Hire Me
                        </motion.a>
                    </div>
                    {/* Mobile Menu Button */}
                    <div className="flex lg:hidden items-center space-x-4 PX-2">
                        <motion.button
                            ...
                            className={`p2 rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-200'} `}>
                            {isMenuOpen ? (
